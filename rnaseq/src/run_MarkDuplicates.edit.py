...
parser.add_argument('--ParallelGCThreads', default=4, type=int) # 追加した
...
with cd(args.output_dir):
    ...
    subprocess.check_call('java -jar -Xmx{}g -XX:ParallelGCThreads={} {}'.format(args.memory, args.ParallelGCThreads, args.jar)\
