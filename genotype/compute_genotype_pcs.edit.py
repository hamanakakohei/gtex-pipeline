...
def patch_fam_phenotype(fam_in, fam_out):
...
if __name__ == '__main__':
    ...
    fam_file = plink_filtered_path+'.pruned.fam'
    os.rename(fam_file, fam_file+'.orig')
    patch_fam_phenotype(fam_file+'.orig', fam_file)
